...
export const UpdateBook = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-lg mx-auto">
      ...
      <div className="mb-4">
        <label htmlFor="author" className="block mb-2 text-lg font-medium text-gray-700">
          Author
        </label>
        <input
          type="text"
      ...
      <div className="mb-4">
        <label htmlFor="genre" className="block mb-2 text-lg font-medium text-gray-700">
          Genre
        </label>
        <input
          type="text"
          ...
          className={`w-full px-4 py-2 border rounded-lg ${errors.genre ? "border-red-500" : "border-gray-300"}`}
        />
        {errors.genre && <span className="text-red-500">Genre is required</span>}
      </div>

      <div className="mb-4">
        <label htmlFor="publicationDate" className="block mb-2 text-lg font-medium text-gray-700">
          Publication Date
        </label>
        <input
          type="text"
          id="publicationDate"
          defaultValue={new Date(book?.data?.publicationDate).toLocaleDateString()}
          {...register("publicationDate", { required: true })}
          className={`w-full px-4 py-2 border rounded-lg ${errors.publicationDate ? "border-red-500" : "border-gray-300"}`}
        />
